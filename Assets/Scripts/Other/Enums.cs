public enum Obj
{
    ...
    TransmissionTower=200, Battery=201, CombustionGenerator=210, SteamGenerator=211,  SolarPanel1=215, WindTurbine1=220, WindTurbine2=221,
...
{
    None=0,
    Sapling, Wood, CompressedWood, Planks,
    StoneOre, StoneBrick,
    CopperOreCtm, CopperOre, CopperDust, CopperPlate, CopperCable, WoodenCircuit,
    IronOre, IronDust, IronPlate, IronGear, IronRod, Steel, Magnet,
...
public enum Technologies
{
    ...
    OrganicOil=81, DroneStation=82, BagOfSand=83, WindTurbine1=84, WindTurbine2=85, Magnet=86, CompressedWood=87, CoalSmelting2=88,
}